        ...
        $treeBuilder->getRootNode()
            ->children()
                ...
                ->arrayNode('templates')->info('Defines the default templates')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('breadcrumb_json_ld')->defaultValue('@UmanitSeo/breadcrumb/breadcrumb.json-ld.html.twig')->end()
                        ->scalarNode('breadcrumb_microdata')->defaultValue('@UmanitSeo/breadcrumb/breadcrumb.microdata.html.twig')->end()
                        ->scalarNode('breadcrumb_rdfa')->defaultValue('@UmanitSeo/breadcrumb/breadcrumb.rdfa.html.twig')->end()
                    ->end()
                ->end()
